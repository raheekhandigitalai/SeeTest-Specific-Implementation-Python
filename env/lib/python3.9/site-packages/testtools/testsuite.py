...
class ConcurrentTestSuite(unittest.TestSuite):
    ...
    def __init__(self, suite, make_tests, wrap_result=None):
        ...
        :param make_tests: A conf function to split the tests in the
    ...
    def run(self, result):
        ...
        This calls out to the provided make_tests conf, and then serialises
...
class ConcurrentStreamTestSuite:
    ...
    def __init__(self, make_tests):
        ...
        :param make_tests: A conf function that should return some number
    ...
    def run(self, result):
        ...
        This calls out to the provided make_tests conf to determine the
...
def filter_by_ids(suite_or_case, test_ids):
    ...
    This conf exists to provide backwards compatibility with older versions
