...
# override
# Add appium_tests prefix for the non-W3C capabilities


def _make_w3c_caps(caps: Dict) -> Dict[str, List[Dict[str, Any]]]:
    appium_prefix = 'appium_tests:'
...
class WebDriver(
    ...
    def find_element(self, by: str = By.ID, value: Union[str, Dict] = None) -> MobileWebElement:
        ...
        Returns:
            `appium_tests.webdriver.webelement.WebElement`: The found element
    ...
    def find_elements(self, by: str = By.ID, value: Union[str, Dict] = None) -> Union[List[MobileWebElement], List]:
        ...
        Returns:
            :obj:`list` of :obj:`appium_tests.webdriver.webelement.WebElement`: The found elements
        """
        # TODO: If we need, we should enable below converter for Web context
        # if self.w3c:
        #     if by == By.ID:
    ...
    def set_value(self, element: MobileWebElement, value: str) -> T:
        ...
        Returns:
            `appium_tests.webdriver.webdriver.WebDriver`: Self instance
        """
        data = {
            'id': element.id,
            'value': [value],
    ...
    def switch_to(self) -> MobileSwitchTo:
        ...
        Override for appium_tests

        Returns:
            `appium_tests.webdriver.switch_to.MobileSwitchTo`
    ...
    def _addCommands(self) -> None:
        ...
        # appium_tests.webdriver.webdriver.WebDriver and its sub-classes
        ...
        self.command_executor._commands[Command.SET_IMMEDIATE_VALUE] = (
            'POST',
            '/session/$sessionId/appium_tests/element/$id/value',
        )

        # TODO Move commands for element to webelement
        self.command_executor._commands[Command.REPLACE_KEYS] = (
            'POST',
            '/session/$sessionId/appium_tests/element/$id/replace_value',
        )
