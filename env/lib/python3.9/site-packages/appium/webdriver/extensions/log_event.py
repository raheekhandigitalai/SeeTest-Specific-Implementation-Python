...
class LogEvent(webdriver.Remote):
    def get_events(self: T, type: List[str] = None) -> Dict[str, Union[str, int]]:
        ...
        Usage:
            ...
            | events = driver.get_events(['appium_tests:funEvent'])
        ...
        Returns:
            `dict`: A dictionary of events timing information containing the following entries
                ...
                | cmd: The command name that has been sent to the appium_tests server
    ...
    def log_event(self: T, vendor: str, event: str) -> T:
        ...
        Usage:
            driver.log_event('appium_tests', 'funEvent')
    ...
    def _addCommands(self) -> None:
        self.command_executor._commands[Command.GET_EVENTS] = ('POST', '/session/$sessionId/appium_tests/events')
        self.command_executor._commands[Command.LOG_EVENT] = ('POST', '/session/$sessionId/appium_tests/log_event')
