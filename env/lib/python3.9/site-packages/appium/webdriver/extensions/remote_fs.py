...
class RemoteFS(webdriver.Remote):
    ...
    def _addCommands(self) -> None:
        self.command_executor._commands[Command.PULL_FILE] = ('POST', '/session/$sessionId/appium_tests/device/pull_file')
        self.command_executor._commands[Command.PULL_FOLDER] = ('POST', '/session/$sessionId/appium_tests/device/pull_folder')
        self.command_executor._commands[Command.PUSH_FILE] = ('POST', '/session/$sessionId/appium_tests/device/push_file')
