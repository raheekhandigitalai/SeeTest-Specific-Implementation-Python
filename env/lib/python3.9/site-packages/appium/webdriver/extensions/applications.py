...
if TYPE_CHECKING:
    ...
    from appium_tests.webdriver.webdriver import WebDriver
...
class Applications(webdriver.Remote):
    ...
    def _addCommands(self) -> None:
        self.command_executor._commands[Command.BACKGROUND] = ('POST', '/session/$sessionId/appium_tests/app/background')
        self.command_executor._commands[Command.IS_APP_INSTALLED] = (
            'POST',
            '/session/$sessionId/appium_tests/device/app_installed',
        )
        self.command_executor._commands[Command.INSTALL_APP] = ('POST', '/session/$sessionId/appium_tests/device/install_app')
        self.command_executor._commands[Command.REMOVE_APP] = ('POST', '/session/$sessionId/appium_tests/device/remove_app')
        self.command_executor._commands[Command.TERMINATE_APP] = (
            'POST',
            '/session/$sessionId/appium_tests/device/terminate_app',
        )
        self.command_executor._commands[Command.ACTIVATE_APP] = (
            'POST',
            '/session/$sessionId/appium_tests/device/activate_app',
        )
        self.command_executor._commands[Command.QUERY_APP_STATE] = (
            'POST',
            '/session/$sessionId/appium_tests/device/app_state',
        )
        self.command_executor._commands[Command.GET_APP_STRINGS] = ('POST', '/session/$sessionId/appium_tests/app/strings')
        self.command_executor._commands[Command.RESET] = ('POST', '/session/$sessionId/appium_tests/app/reset')
        self.command_executor._commands[Command.LAUNCH_APP] = ('POST', '/session/$sessionId/appium_tests/app/launch')
        self.command_executor._commands[Command.CLOSE_APP] = ('POST', '/session/$sessionId/appium_tests/app/close')
