...
class Settings(webdriver.Remote):
    def get_settings(self: T) -> Dict[str, Any]:
        """Returns the appium_tests server Settings for the current session.
    ...
    def _addCommands(self) -> None:
        self.command_executor._commands[Command.GET_SETTINGS] = ('GET', '/session/$sessionId/appium_tests/settings')
        self.command_executor._commands[Command.UPDATE_SETTINGS] = ('POST', '/session/$sessionId/appium_tests/settings')
