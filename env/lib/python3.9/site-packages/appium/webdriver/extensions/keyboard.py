...
class Keyboard(webdriver.Remote):
    ...
    def _addCommands(self) -> None:
        self.command_executor._commands[Command.HIDE_KEYBOARD] = (
            'POST',
            '/session/$sessionId/appium_tests/device/hide_keyboard',
        )
        self.command_executor._commands[Command.IS_KEYBOARD_SHOWN] = (
            'GET',
            '/session/$sessionId/appium_tests/device/is_keyboard_shown',
        )
        self.command_executor._commands[Command.KEY_EVENT] = ('POST', '/session/$sessionId/appium_tests/device/keyevent')
        self.command_executor._commands[Command.PRESS_KEYCODE] = (
            'POST',
            '/session/$sessionId/appium_tests/device/press_keycode',
        )
        self.command_executor._commands[Command.LONG_PRESS_KEYCODE] = (
            'POST',
            '/session/$sessionId/appium_tests/device/long_press_keycode',
        )
