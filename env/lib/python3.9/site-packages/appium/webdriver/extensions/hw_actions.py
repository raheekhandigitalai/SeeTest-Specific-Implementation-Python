...
class HardwareActions(webdriver.Remote):
    ...
    def _addCommands(self) -> None:
        self.command_executor._commands[Command.LOCK] = ('POST', '/session/$sessionId/appium_tests/device/lock')
        self.command_executor._commands[Command.UNLOCK] = ('POST', '/session/$sessionId/appium_tests/device/unlock')
        self.command_executor._commands[Command.IS_LOCKED] = ('POST', '/session/$sessionId/appium_tests/device/is_locked')
        self.command_executor._commands[Command.SHAKE] = ('POST', '/session/$sessionId/appium_tests/device/shake')
        self.command_executor._commands[Command.TOUCH_ID] = ('POST', '/session/$sessionId/appium_tests/simulator/touch_id')
        self.command_executor._commands[Command.TOGGLE_TOUCH_ID_ENROLLMENT] = (
            'POST',
            '/session/$sessionId/appium_tests/simulator/toggle_touch_id_enrollment',
        )
        self.command_executor._commands[Command.FINGER_PRINT] = (
            'POST',
            '/session/$sessionId/appium_tests/device/finger_print',
        )
