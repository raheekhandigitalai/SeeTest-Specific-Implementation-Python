...
class Network(webdriver.Remote):
    ...
    def network_connection(self: T) -> int:
        ...
        Android only.
        Possible values are available through the enumeration `appium_tests.webdriver.ConnectionType`
        """
    ...
    def set_network_connection(self: T, connection_type: int) -> int:
        ...
        These are available through the enumeration `appium_tests.webdriver.ConnectionType`

        Args:
            connection_type: a member of the enum `appium_tests.webdriver.ConnectionType`
    ...
    def set_network_speed(self: T, speed_type: str) -> T:
        ...
        Args:
            speed_type: The network speed type.
                A member of the const appium_tests.webdriver.extensions.android.network.NetSpeed.
    ...
    def _addCommands(self) -> None:
        self.command_executor._commands[Command.TOGGLE_WIFI] = ('POST', '/session/$sessionId/appium_tests/device/toggle_wifi')
        ...
        self.command_executor._commands[Command.SET_NETWORK_SPEED] = (
            'POST',
            '/session/$sessionId/appium_tests/device/network_speed',
        )
