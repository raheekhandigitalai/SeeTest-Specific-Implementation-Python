...
class Power(webdriver.Remote):
    ...
    def _addCommands(self) -> None:
        self.command_executor._commands[Command.SET_POWER_CAPACITY] = (
            'POST',
            '/session/$sessionId/appium_tests/device/power_capacity',
        )
        self.command_executor._commands[Command.SET_POWER_AC] = ('POST', '/session/$sessionId/appium_tests/device/power_ac')
