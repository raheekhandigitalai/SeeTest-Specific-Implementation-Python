...
class Gsm(webdriver.Remote):
    def make_gsm_call(self: T, phone_number: str, action: str) -> T:
        ...
        Args:
            ...
            action: The call action.
                A member of the const `appium_tests.webdriver.extensions.android.gsm.GsmCallActions`
    ...
    def set_gsm_signal(self: T, strength: int) -> T:
        ...
        Args:
            strength: Signal strength.
                A member of the enum :obj:`appium_tests.webdriver.extensions.android.gsm.GsmSignalStrength`
    ...
    def set_gsm_voice(self: T, state: str) -> T:
        ...
        Args:
            state: State of GSM voice.
                A member of the const `appium_tests.webdriver.extensions.android.gsm.GsmVoiceState`
    ...
    def _addCommands(self) -> None:
        self.command_executor._commands[Command.MAKE_GSM_CALL] = ('POST', '/session/$sessionId/appium_tests/device/gsm_call')
        self.command_executor._commands[Command.SET_GSM_SIGNAL] = (
            'POST',
            '/session/$sessionId/appium_tests/device/gsm_signal',
        )
        self.command_executor._commands[Command.SET_GSM_VOICE] = ('POST', '/session/$sessionId/appium_tests/device/gsm_voice')
