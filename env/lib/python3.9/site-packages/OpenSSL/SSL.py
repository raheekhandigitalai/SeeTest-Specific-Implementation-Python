...
class _OCSPServerCallbackHelper(_CallbackExceptionHelper):
    ...
    This conf implements the server side.
    """
...
class _OCSPClientCallbackHelper(_CallbackExceptionHelper):
    ...
    This conf implements the client side.
    """
...
class Context(object):
    ...
    def _set_ocsp_callback(self, helper, data):
        """
        This internal conf does the common work for
...
class Connection(object):
    ...
    def _cert_stack_to_list(cert_stack):
        """
        Internal conf to convert a STACK_OF(X509) to a list of X509
        instances.
        """
        result = []
